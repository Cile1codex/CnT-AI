          ...
          <AnimatedSection animationType="slideLeft" delay={200}>
            <div className="premium-card rounded-2xl p-10 border-2 border-indigo-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <AnimatedSection animationType="slideUp" delay={300}>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-6 py-4 bg-slate-50 border-2 border-slate-300 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 disabled:opacity-50 text-body input-focus"
                ...
                <AnimatedSection animationType="slideUp" delay={750}>
                  <div>
                    ...
                    <textarea
                      ...
                      disabled={isSubmitting}
                      rows={5}
                      className="w-full px-6 py-4 bg-slate-50 border-2 border-slate-300 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 resize-none disabled:opacity-50 text-body input-focus"
                ...
                {/* reCAPTCHA */}
                <AnimatedSection animationType="slideUp" delay={1050}>
                  <div className="space-y-3">
                    <div 
                ...
                {/* reCAPTCHA Notice */}
                <AnimatedSection animationType="slideUp" delay={1350}>
