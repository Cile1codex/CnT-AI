      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {useCases.map((useCase, index) => (
            ...
            >
              <div className="premium-card rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 hover-scale will-change-transform">
                ...
                <div className="mt-8 pt-6 border-t border-slate-200">
                  <Link 
                    ...
                    className="text-purple-600 font-semibold hover:text-purple-500 transition-all duration-200 link-hover inline-block"
        ...
        <AnimatedSection className="mt-16 text-center" delay={800}>
          <div className="cta-gradient rounded-2xl p-8 text-white">
            ...
            <button 
              ...
              className="bg-white text-purple-600 font-medium px-8 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300 btn-hover"
            >
