...
export const TermsOfServiceMK: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50">
      <SEOHead 
        title="Услови за користење - CnT AI"
        description="Услови за користење на CnT AI. Прочитајте ги условите и правилата за користење на нашите услуги."
      />
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 md:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed">
                CnT AI обезбедува AI автоматизација, chatbots, автоматизирани веб-страници, backend интеграции и поврзани услуги.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed">
                Целата содржина на страницата е сопственост на CnT AI. Репродукцијата или неовластената употреба е забранета.
              </p>
            </section>
