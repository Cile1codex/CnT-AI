        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex justify-center mb-8">
              <div className="premium-card-dark rounded-full px-8 py-4 animate-fade-in-scale">
                <span className="text-purple-300 font-medium">Еден стратешки повик. Една прилагодена автоматизација. Во живо за 72 часа.</span>
              </div>
            </div>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 transition-all duration-1000 delay-300 ${
            ...
            <div className="premium-card-dark rounded-2xl p-8 hover-scale will-change-transform">
              ...
              <h3 className="text-white font-bold text-xl mb-4">Вистинска АИ. Вистински Резултати.</h3>
              <p className="text-gray-400">Нашите решенија се интегрираат директно со вашите работни процеси и алатки</p>
            </div>
            
            <div className="premium-card-dark rounded-2xl p-8 hover-scale will-change-transform">
              <Zap className="h-16 w-16 text-teal-400 mb-6 mx-auto" />
              <h3 className="text-white font-bold text-xl mb-4">24/7 Системи</h3>
              <p className="text-gray-400">Од чатботови до backend процеси, вашите системи никогаш не спијат</p>
            </div>
            
            <div className="premium-card-dark rounded-2xl p-8 hover-scale will-change-transform">
              <TrendingUp className="h-16 w-16 text-pink-400 mb-6 mx-auto" />
              <h3 className="text-white font-bold text-xl mb-4">Брза Имплементација. Брз ROI.</h3>
              <p className="text-gray-400">Нашите клиенти почнуваат да гледаат резултати во рок од денови</p>
            </div>
          </div>
        </div>
      </div>
