        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <p className="text-lg text-slate-600 leading-relaxed">
              Во CnT AI, веруваме дека најдобрите бизниси не работат потешко — туку попаметно. Нашата мисија е да им помогнеме на модерните компании да ги елиминираат повторливите задачи, да ги поедностават нивните backend процеси и да отклучат скалабилен раст преку прилагодена АИ автоматизација.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
