...
export const UseCases: React.FC = () => {
  ...
  const useCases = [
    {
      icon: Store,
      industry: 'Агенција за Недвижности - DarmaDoma',
    ...
    },
    {
      icon: Laptop,
      industry: 'Агенција за Недвижности - DarmaDoma',
      title: 'Систем за Управување со Тимски Задачи',
      challenge: 'Неорганизиран тим. Директорот не можеше да ги следи задачите. Вработените пропуштаа рокови. Хаос во комуникацијата.',
      solution: 'Платформа за управување со задачи со акаунти базирани на улоги. Email известувања. Следење на статусот. Систем за белешки. Заштедени безброј часови и главоболки.',
      results: ['Целосна видливост на задачите за директорот', 'Автоматизирани email известувања', 'Зголемена продуктивност и профит'],
      color: 'from-emerald-500 to-teal-600',
      caseStudyPath: '/mk/case-study-team-task-management',
    },
  ];
