      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl font-bold text-slate-800 mb-6 tracking-tight">
            Имате Прашања или <span className="bg-gradient-to-r from-purple-600 to-teal-600 bg-clip-text text-transparent">Деловни Барања</span>?
          </h2>
                ...
                <div className="mb-6 p-6 premium-card border border-emerald-200 rounded-lg">
                  ...
                  <div className="space-y-2 text-emerald-700">
                    <div className="flex items-center">
                      ...
                      <span>Ги прегледуваме вашите работни текови</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                      <span>Ги идентификуваме вашите најголеми тесни грла</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                      <span>Ви покажуваме што можеме да автоматизираме веднаш</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
                      <span>Го лансираме вашиот прв систем—често во рок од 48–72 часа</span>
                    </div>
                  </div>
