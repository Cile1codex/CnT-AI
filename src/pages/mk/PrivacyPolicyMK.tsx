...
export const PrivacyPolicyMK: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50">
      <SEOHead 
        title="Политика за приватност - CnT AI"
        description="Политика за приватност на CnT AI. Дознајте како ги собираме, користиме и заштитуваме вашите лични податоци."
      />
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 md:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 mb-8">
              <strong>Датум на влегување во сила:</strong> 1 јануари 2025
            </p>
            
            <p className="text-slate-700 leading-relaxed mb-8">
              CnT AI ("ние", "нас", "наше") управува со https://cnt-ai.com ("Услуга"). Вашата приватност и доверба многу ни значат. Оваа изјава објаснува кои податоци ги собираме, зошто ги собираме, како ги користиме и вашите права.
            </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700">
                ...
                <li><strong>Технички податоци:</strong> IP адреса, информации за прелистувач/уред, посетени страници, referrer URLs.</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed">
                Не ги продаваме или изнајмуваме вашите податоци. Можеме да споделуваме информации со доверливи давателите на услуги (на пр. хостинг, CRM) или со властите кога е правно потребно.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed">
                Можеме да ја ревидираме оваа политика. Промените влегуваат во сила кога се објавени.
              </p>
            </section>
